    ...
    <footer className="mt-2 flex flex-col items-center w-screen">
      ...
      <div className="mt-6 flex flex-wrap gap-4 justify-center">
        <Link
          href={linkedin}
          target="_blank"
          className="sm:h-fit sm:p-2 px-4 py-2 rounded-l-full rounded-r-full bg-[#0077b5] text-white text-lg flex gap-2 items-center transition-all ease-in-out hover:transform  hover:scale-110 "
        >
        ...
        <Link
          href={github}
          target="_blank"
          className=" sm:h-fit sm:p-2 px-4 py-2 rounded-l-full rounded-r-full bg-[#2b3137] text-white text-lg flex gap-2 items-center transition-all ease-in-out hover:transform  hover:scale-110"
        >
        ...
        <Link
          href={`mailto:${mail}`}
          target="_blank"
          className=" sm:h-fit sm:p-2 px-4 py-2 rounded-l-full rounded-r-full bg-gradient-to-l from-[#3e65cf] to-[#f67470]   text-white text-lg flex gap-2 items-center transition-all ease-in-out hover:transform  hover:scale-110"
        >
