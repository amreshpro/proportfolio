...
export  default function Skills() {
  return (
    <div className="flex flex-col justify-center items-center">
      <h1 id="skills" className=" text-3xl sm:text-2xl font-bold  text-center my-4 ">
        Skills
      </h1>
...
function SkillTag({ name, image_url }:{name:string,image_url:string}) {
   return (
    <div className={`bg-secondary border  hover:animate-bounce p-2.5 rounded-lg w-20 h-20 flex flex-col justify-center items-center`}>
