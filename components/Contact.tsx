...
export function Contact() {
  ...
  return (
    <div className={` ${isDarkMode ? "contact-dark " : "contact-light"}  sm:px-4 py-4 sm:py-2 flex flex-col gap-4 justify-center items-center`}>
      ...
      <div className="mt-6 contact-container flex sm:flex-col gap-8 sm:gap-4 ">
        ...
        <div className="mail flex gap-2">
          ...
          <div className="content flex flex-col ">
            <Link href="mailto:amresh.terminal@gmail.com" className="font-bold">Mail</Link>
            <Link href="mailto:amresh.terminal@gmail.com">amresh.terminal@gmail.com</Link>
          </div>
        </div>
      </div>
    </div>
