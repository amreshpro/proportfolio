...
export default function SkillTag({ name, image_url }:{name:string,image_url:string}) {
    return (
     <div className={`bg-ternary backdrop-blur-lg hover:bg-ternary border  hover:animate-bounce p-2.5 rounded-lg w-20 h-20 flex flex-col justify-center items-center`}>
